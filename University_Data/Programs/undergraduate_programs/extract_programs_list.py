...
def get_undergraduate_programs(url, university_name, existing_data=None):
    ...
    prompt_names = (
        ...
        "4. Program Names should be always complete like 'Bachelor of Science in Biology' not just 'Biology'\n"
        "5. If the university uses 'Concentrations', 'Areas of Study', or 'Fields of Study', treat those as the program names.\n\n"
        "6. Make sure the program names are in the format 'Degree in Program Name' not 'Program Name in Degree' (e.g., 'Bachelor of Science in Biology' not 'Biology in Bachelor of Science')\n"
